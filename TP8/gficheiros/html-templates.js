...
function fileForm( d ){
    ...
    <html>
        <head>
            ...
            <link rel="stylesheet" href="/w3.css"/>
            <script src="/jquery-3.5.1.min.js"></script>
            <script src="/moreFiles.js"></script>
            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.js"></script>
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.css" />
        </head>
        <body>
            ...
            <form class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
                ...
                <label class="w3-btn w3-amber" onclick="moreFiles();">Add file</label>
                <label class="w3-btn w3-amber" onclick="lessFiles();">Remove file</label>
            </form>
